...
import styles from './DataScrollerItem.scss';
...
class DataScrollerItem extends React.Component {
  render() {
    const {
      children,
      refCallback,
...
DataScrollerItem.propTypes = propTypes;
DataScrollerItem.defaultProps = defaultProps;

export default DataScrollerItem;
