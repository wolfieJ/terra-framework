...
class DateTimePicker extends React.Component {
  ...
  handleTimeChange(event, time) {
    ...
    if (validDate && validTime) {
      ...
      // it could have subtracted an hour from above to account for the missing hour. displayedTimeValue is only
      // used in handleChangeRaw. The actual update to this.timeValue happens in componentDidUpdate.
      if (updatedDateTime) {
